...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME="event_db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            sqLiteDatabase.execSQL(EventDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(EventDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql , String...where){
        Cursor cursor = db.rawQuery("select * from "+EventDB.TABLE_NAME,where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
